...
st.sidebar.write("[Sample data for upload](https://github.com/robin991/Quality_Check_Solution/tree/main/data)")
...
if not df.empty:
    ...
    st.write('You can further analyse the below output using uploaded file:')
